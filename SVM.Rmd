...
library(kernlab)
svm_model<-ksvm(as.factor(Response)~. , data= marketing_train, kernel="rbfdot", prob.model = TRUE)
...
```{r}
svm_probs <- predict(svm_model, marketing_test, type = "probabilities")
svm_probs_1 <- svm_probs[, "1"]
```
